...
5. Personaの「trigger_signals」と「red_flags」を見て、今回の材料に合う者だけを選ぶ
6. 選ばないPersonaにも、今回なぜ外したかを skip_reasons に具体的に残す
7. selected_personas は「広く網羅する」より「役割が重ならず相補的である」ことを優先する
8. optional_notes にある口調・匿名性・安全ガードが強いPersonaは、それを壊す役割を割り当てない
